  ...
  tagList( 
    ...
    card(
      ...
      layout_columns(
        ...
        card_body(tags$img(src='footer-logo.png', style="margin-top: 0x; padding-left: 0px; padding-right: 0px;", class = "responsive-image", alt = "Image of PSRC Jewel"), class = "footer_panel"),
        ...
        layout_columns(
          ...
          card_body(div(
            a(class = "footer_url", 
              ...
              icon("facebook", alt = "Link to PSRC's Facebook page"), 
              target="_blank"),
            a(class = "footer_url", 
              href="https://twitter.com/SoundRegion", 
              icon("x-twitter", alt = "Link to PSRC's Twitter feed"), 
              target="_blank"),
            a(class = "footer_url", 
              href="https://www.instagram.com/soundregion/", 
              icon("instagram", alt = "Link to PSRC's Instagram feed"), 
              target="_blank"),
            a(class = "footer_url", 
              href="https://www.linkedin.com/company/soundregion", 
              icon("linkedin", alt = "Link to PSRC's LinkedIn feed"), 
              target="_blank")
          )),
